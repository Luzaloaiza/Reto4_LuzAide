...
public class SucursalForm extends javax.swing.JDialog {
   ...
   Statement st;
    ...
    public void recibeIdDireccion(int idDireccion){
        ...
        String queryRegsitroSucursal = "INSERT INTO `sucursal`(`nombreSucursal`, `FK_nit`, `FK_idDireccion`) VALUES ('"+sucursal+"','"+nit+"','"+idDireccion+"')";
        System.out.println(queryRegsitroSucursal);
        try{
           connection =conexion.getConnection();
           st = connection.createStatement();
           st.executeUpdate(queryRegsitroSucursal);
